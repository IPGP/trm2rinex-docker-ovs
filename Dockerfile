...
# Checkout Wine Release 6.22 - NEW STYLE, clone only the needed branch => much FASTER
...
RUN dpkg --add-architecture i386 \
    ...
    libx11-dev libxext-dev libxinerama-dev libxrandr-dev libxrender-dev libxi-dev \
    #### new stuffs PS250509
    ...
    #libxext-dev:i386 libxrender-dev:i386 libxrandr-dev:i386 \
    #libxi-dev:i386 libxcursor-dev:i386 libxinerama-dev:i386 \
    #libxcomposite-dev:i386 libasound2-dev:i386 \
    #libpulse-dev:i386 libdbus-1-dev:i386 \
    #libv4l-dev:i386 libudev-dev:i386 \
    #libgphoto2-dev:i386 libgsm1-dev:i386 \
    #libopenal-dev:i386 libvulkan-dev:i386 \
    #flex bison \
    && DEBIAN_FRONTEND="noninteractive" apt-get clean -y \        
    && rm -rf /var/lib/apt/lists/* 
...
ADD --chown=1001:${USER_GID} https://dl.tbcrelease.net/update/config/25.4.16/TrimbleCFGUpdate.exe /tmp
